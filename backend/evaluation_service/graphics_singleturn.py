...
# codellama
with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/codellama_1.json",
    "r",
) as f:
    data_codellama_1 = json.load(f)

with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/codellama_2.json",
    "r",
) as f:
    data_codellama_2 = json.load(f)

with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/codellama_3.json",
    "r",
) as f:
...
# llama2
with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/llama2_1.json",
    "r",
) as f:
    data_llama2_1 = json.load(f)

with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/llama2_2.json",
    "r",
) as f:
    data_llama2_2 = json.load(f)

with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/llama2_3.json",
    "r",
) as f:
...
# zephyr
with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/zephyr_1.json",
    "r",
) as f:
    data_zephyr_1 = json.load(f)

with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/zephyr_2.json",
    "r",
) as f:
    data_zephyr_2 = json.load(f)

with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/zephyr_3.json",
    "r",
) as f:
...
# llama3.1
with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/llama3.1_8b_1.json",
    "r",
) as f:
    data_llama3_1_8b_1 = json.load(f)

with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/llama3.1_8b_2.json",
    "r",
) as f:
    data_llama3_1_8b_2 = json.load(f)

with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/llama3.1_8b_3.json",
    "r",
) as f:
...
# llama3.1:70b
with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/llama3.1_70b_1.json",
    "r",
) as f:
    data_llama3_1_70b_1 = json.load(f)

with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/llama3.1_70b_2.json",
    "r",
) as f:
    data_llama3_1_70b_2 = json.load(f)

with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/llama3.1_70b_3.json",
    "r",
) as f:
...
# gemma3:27b
with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/gemma3_27b_1.json",
    "r",
) as f:
    data_gemma3_27b_1 = json.load(f)

with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/gemma3_27b_2.json",
    "r",
) as f:
    data_gemma3_27b_2 = json.load(f)

with open(
    f"results/attacker_llm/{malicious_or_vulnerable}/single_turn/role_play/{type_role_play}/gemma3_27b_3.json",
    "r",
) as f:
...
for model_name, list_of_model_datasets in datasets_map.items():
    for individual_dataset_run in list_of_model_datasets:
        ...
        print(
            f"{model_name} run {len(model_acceptance_rates_per_run[model_name])}: {n_falses}/{num_responses} acceptance = {acceptance_rate:.3f} acceptance rate"
        )
...
make_bar_chart_with_std(
    data,
    f"{malicious_or_vulnerable.title()} - Single Turn Role Play (Mr. Robot ) - 3 runs each, {num_responses} entries per run",
